...
class Person final :
 ...
 public:
  ...
  // @@protoc_insertion_point(class_scope:proto_test.Person)
 private:
  class _Internal;
...
inline const std::string& Person::name() const {
  // @@protoc_insertion_point(field_get:proto_test.Person.name)
...
void Person::set_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:proto_test.Person.name)
}
inline std::string* Person::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:proto_test.Person.name)
  return _s;
}
...
inline std::string* Person::release_name() {
  // @@protoc_insertion_point(field_release:proto_test.Person.name)
